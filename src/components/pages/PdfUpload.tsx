...
export function PdfUpload() {
  ...
  return (
    <div className="w-full max-w-lg mx-auto">
      <p className="mb-2 text-sm font-medium text-gray-700">Upload PDF</p>
      ...
      <div
        ...
        onClick={() => !isSuccess && !isUploading && inputRef.current?.click()}
        className={[
        ...
        {isUploading && uploadedFile && (
          <>
            ...
            <div className="text-center">
              ...
              <p className="mt-1 text-xs text-gray-400">{uploadedFile.size}</p>
            </div>
            {/* Progress bar */}
            <div className="w-full max-w-xs h-1.5 rounded-full bg-gray-200 overflow-hidden">
              <div className="h-full bg-blue-500 rounded-full animate-[progress_1.2s_ease-in-out_forwards]" />
            </div>
        ...
        {isSuccess && uploadedFile && (
          <>
            ...
            <div className="text-center">
              ...
              <p className="mt-0.5 text-xs text-gray-400">{uploadedFile.size}</p>
            ...
            <button
              ...
              className="absolute top-3 right-3 flex h-7 w-7 items-center justify-center rounded-full bg-white shadow hover:bg-gray-100 transition-colors"
